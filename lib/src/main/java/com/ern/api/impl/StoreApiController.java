...
*/
public final class StoreApiController {

    private static StoreApiRequestHandlerProvider sRequestHandler;
    ...
    public static void register(@Nullable StoreApiRequestHandlerProvider.StoreApiConfig requestHandlerConfig) {
        if (sRequestHandler == null) {
            ...
            Log.w("StoreController", "A request handler is already registered, ignoring duplicate register call");
        }
    }
}
