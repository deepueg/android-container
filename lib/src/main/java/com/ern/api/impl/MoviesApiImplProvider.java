 ...
 */
public class MoviesApiImplProvider extends ApiImplProvider<MoviesApiImplProvider.MoviesApiRequestHandlerConfig> implements MovieApiRequestHandlerProvider {
     ...
     */
    public MoviesApiImplProvider(@Nullable RequestHandlerConfig<MoviesApiRequestHandlerConfig> requestHandlerConfig) {
    ...
    public static class MoviesApiRequestHandlerConfig {

        public MoviesApiRequestHandlerConfig() {
            //TODO: Customize this class as needed for implementing request handlers.
        }
    }
}
